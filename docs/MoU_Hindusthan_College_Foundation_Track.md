...
This Memorandum of Understanding (“**MoU**”) is entered into on this ______ day of ______________ 2026 (“**Effective Date**”)
...
## 4. PROGRAM DETAILS — FOUNDATION TRACK: PYTHON, DATA & AI

### 4.1 Track Overview

| Attribute | Details |
|-----------|---------|
| **Track Name** | Foundation Track: Python, Data & AI |
| **Difficulty** | Beginner (Foundation Level — Track Level 1) |
| **Duration** | 10 intensive weeks (equivalent to ~6 months of structured engineering depth) |
| **Tagline** | Master Python engineering, databases, data science, and AI-ready foundations |

### 4.2 Curriculum Coverage

The Track covers Linux, Git, core Python, DSA, OOP, REST APIs, database engineering, Python for data science, AI foundations, and a capstone sprint. Each week includes 12+ deep-dive topics with CLI labs, industry scenarios, and hands-on walkthroughs.

**Indicative weekly themes include:**

- Week 1: Engineering Setup & Computational Thinking (Linux, Git, debugging mindset)
- Week 2: Core Python Engineering
- Week 3: Logic Building & Algorithmic Thinking
- Week 4: Functional Programming & Modular Systems
- Week 5–9: Data structures, OOP, APIs, databases, data science foundations (as per published curriculum)
- Week 10: Capstone sprint and industry presentation

### 4.3 Learning Deliverables per Student
...
5. **24/7 lesson-scoped AI tutor** (disabled during quizzes to preserve academic integrity)
6. **Weekly assessments** — 50 questions per week (MCQ, debugging, output prediction, scenarios); 80% pass threshold; up to 3 retries per quiz
7. **Interview preparation modules** — industry Q&A, CLARIFY method, mock dialogue per module
...
- Git workflow and PR culture
- Terminal/Linux proficiency
- Working GitHub portfolio (labs + capstone)
- Weekly quiz scores as proof of mastery
- Interview prep module completion
- Backend-ready skills: automation, APIs, debugging, data foundations
...
(b) Provide master curriculum and periodic content updates for the Track

(c) Conduct weekly live mentor sessions and share recordings on the Platform

(d) Provide AI tutoring scoped to lesson content (with quiz-time restrictions)

(e) Issue QR-verified certificates to Students meeting completion criteria

(f) Configure the College in the admin portal with department-wise analytics

(g) Provide admin training for TPO/coordinators on bulk student upload, enrollment tracking, and analytics

(h) Provide Excel template for bulk student onboarding

(i) Conduct a student kickoff webinar (virtual) at program start
...
(d) Facilitate enrollment and fee collection (or institutional billing, as agreed)

(e) Ensure Students have laptop, browser, and stable internet access

(f) Encourage timely participation in weekly live sessions and assessments
...
Target program start date: ______________ 2026 (to be confirmed in Annexure A).
...
9.4 Either Party shall notify the other within 48 hours of any suspected data breach affecting Program participants.

---

## 10. CONFIDENTIALITY

10.1 Each Party shall keep confidential all non-public business, technical, financial, and student data received from the other Party during this MoU.

10.2 Confidentiality obligations survive termination for **three (3) years**.

10.3 Exclusions: information already public, independently developed, or required by law to be disclosed.

---

## 11. TERM AND TERMINATION

11.1 This MoU is effective from the Effective Date and remains in force for **twelve (12) months**, automatically renewable for successive 12-month periods unless either Party gives **30 days** written notice of non-renewal.
...
14.1 Parties shall attempt good-faith resolution within **15 days** of written dispute notice.

14.2 Failing resolution, disputes shall be referred to arbitration under the Arbitration and Conciliation Act, 1996, with a sole arbitrator mutually appointed. Seat: **Coimbatore, Tamil Nadu**. Language: English.

14.3 Courts at **Coimbatore** shall have exclusive jurisdiction for interim relief.

---

## 15. GENERAL PROVISIONS

15.1 **Amendments:** Only in writing signed by both Parties.

15.2 **Force Majeure:** Neither Party liable for delays due to events beyond reasonable control (natural disasters, government orders, major infrastructure outages).

15.3 **Notices:** Email to designated contacts below constitutes valid notice.

15.4 **Entire Agreement:** This MoU and Annexures supersede prior discussions on the Program.

15.5 **Severability:** Invalid provisions shall not affect remaining terms.
...
| | |
|---|---|
| Name | Mr. Praveen Manoharan |
| Designation | CTO & Technical Program Manager |
| Signature | _________________________ |
| Date | _________________________ |

**FOR AND ON BEHALF OF HINDUSTHAN COLLEGE OF ENGINEERING AND TECHNOLOGY (HiCET)**
...
| Payment option | Option A / Option B (Clause 6.4) |
| Kickoff webinar date | __________ |
